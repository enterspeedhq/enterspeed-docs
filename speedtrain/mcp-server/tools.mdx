...
| `speedtrain_list_task_config_versions` | Version history, and which one is active. |
| `speedtrain_activate_task_config_version` | Make a version active. Names the version it displaces. |

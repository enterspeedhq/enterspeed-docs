...
<Steps>
  ...
  <Step title="Speedtrain does the work" icon="wand-magic-sparkles">
    A **task configuration** describes the job: who the AI is, what the output varies across, and how each result will be judged. Running it over the index produces one output per document, each scored by your quality rules and routed through a quality gate.

    Nothing leaves Speedtrain until a person accepts it in a **review session**.

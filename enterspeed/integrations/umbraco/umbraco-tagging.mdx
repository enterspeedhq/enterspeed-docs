...
![Umbraco Content Structure](/images/docs/integrations/umbraco/umbraco-v8-site-content-structure.png)
...
![Umbraco blocks](/images/docs/integrations/umbraco/umbraco-v8-blocks.png)

Each of them configured with their own criteria for display of articles:

![Umbraco blocks Content](/images/docs/integrations/umbraco/umbraco-v8-blocks-content.png)

![Umbraco blocks Content basketball](/images/docs/integrations/umbraco/umbraco-v8-blocks-content-basketball.png)

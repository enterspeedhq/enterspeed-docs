...
<Info>
If you want different logic based on content type or other conditions, you should use [Mappers](/enterspeed/integrations/umbraco/additional-properties) instead.
</Info>

...
![Deploy schema](/images/docs/transform/create-schema-with-custom-alias.png)
</Tip>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/3VfROMliTzs" width="100%" height="400" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
</Frame>

...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/KVPvNjcZLvc" width="100%" height="400" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
</Frame>
...
![Create source Enterspeed](/images/docs/tooling/schema-folder-locally.png)

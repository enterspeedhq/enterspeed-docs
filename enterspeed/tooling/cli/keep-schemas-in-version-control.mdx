...
<Frame>
  <iframe src="https://www.youtube.com/embed/5crm4rUMdxU" width="100%" height="400" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
</Frame>
...
First, you must install the Enterspeed CLI. If you haven't worked with the CLI, take a look at the [Getting started guide](/enterspeed/tooling/cli/getting-started).
...
<Tip>
The deployment plan can also be used to deploy the schemas in the correct version in a CD pipeline. [Use Enterspeed CLI in your release pipeline](/enterspeed/tooling/cli/continuous-deployment)
</Tip>

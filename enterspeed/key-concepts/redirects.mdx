...
In Enterspeed you can ingest incoming redirects on your source entities. You do that by using the `X-Enterspeed-Redirects` header in your ingest request or as part of the object in the root property called `redirects` as described in the [API documentation](/api-reference/ingest/save-entity).
...
```
[See redirect API documentation](/enterspeed/reference/js/full-schema/routes#url)

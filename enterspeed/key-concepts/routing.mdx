...
- **Relative URLs** (_e.g. /about-us/_) that can't be matched - add the `root.tld` hostname.
- **Absolute URLs** whose routes were never created - `root.tld` won't help. The actual hostname has to be registered, and the content has to be processed again afterwards.

...
This page tells you **where the server lives**, **how authentication works**, and **what scopes to request**. For step-by-step wiring guides, see [Connecting an agent](/enterspeed/mcp-server/connecting-an-agent) and [Connecting a client](/enterspeed/mcp-server/connecting-a-client).
...
- [Connecting an agent](/enterspeed/mcp-server/connecting-an-agent) — wire a custom C# agent or Azure AI Foundry to the MCP server.
- [Connecting a client](/enterspeed/mcp-server/connecting-a-client) — VS Code, Claude Code, Claude Desktop, or the Anthropic Messages API in C#.

...
- [Connecting a client](/enterspeed/mcp-server/connecting-a-client) — VS Code, Claude Code, Claude Desktop, and the Anthropic Messages API in C#.
- [Overview](/enterspeed/mcp-server/overview) — sample prompts and the full scope table.

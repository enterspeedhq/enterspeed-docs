...
![Create new schema](/images/docs/examples/create-new-schema.png)
...
![Deploying schemas](/images/docs/examples/bulk-deploy.png)

Once the schemas have been deployed you will be able to see the results in **Generated views**.

![Generated views](/images/docs/examples/generated-views.png)

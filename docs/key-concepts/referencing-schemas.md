...
Read more about reference property for JSON schemas [here](//docs/reference/json/property-types.md#reference) or for JS schemas [here](//docs/reference/js/properties.md#reference).

...
```json title="Data source"
{
	...
	"properties": {
      ...
      "seo": {
        ...
        "seoDescription": "Lorem Ipsum er ganske enkelt fyldtekst fra print- og typografiindustrien. Lorem Ipsum har været standard fyldtekst siden 1500-tallet, hvor e"
    }
  }
}
```

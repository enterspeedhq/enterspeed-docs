...
Enterspeed has features like [references](/reference/js/full-schema/properties#reference) and [lookup](/reference/js/full-schema/properties#lookup) that lets you use data from other source entities in the schemas, so use those features instead.

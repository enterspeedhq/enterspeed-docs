...
The EnterspeedJobHandler is responsible for taking a job, fetching data from Umbraco, converting it to an IEnterspeedEntity and sending it to the Enterspeed Ingest API. 
...
This is done by the InvalidateEnterspeedJobs background task.
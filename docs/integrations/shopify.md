...
| Shopify access token                  | A Developer app API access token with the following permissions: `write_product_listings`, `read_product_listings`, `write_products`, `read_products`, `write_publications`, `read_publications` |

...
![Umbraco v10 Content dashboard](/img/docs/integrations/umbraco/umbraco-v8-enterspeed-content-dashboard.png)

## Failed jobs

This list is to get an overview of what, if any, has failed while being sent to the Enterspeed Ingest API.

If an entity fails to be sent, a row will be added and can be unfolded to see error details.

![Umbraco v10 Failed jobs](/img/docs/integrations/umbraco/umbraco-v8-enterspeed-failed-jobs.png)

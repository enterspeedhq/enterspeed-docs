...
Go to https://app.enterspeed.com/settings/environment-settings and create a domain called _localhost_, an _Environment client_ named _Web_ and finally an _Environment_ called _Demo_.
